# Operator Quickstart — Manufacture of Bodies (Coachwork) for Motor Vehicles

Shortest path from clone to a verified local dry-run for **ISIC 2920** (`cloud-itonami-isic-2920`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2920.git
cd cloud-itonami-isic-2920
```
...
- Blueprint governor key: `stamping-governor`
- Likely source path: `bodyshop.governor.cljc`
