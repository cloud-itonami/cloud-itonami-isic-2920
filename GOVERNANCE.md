...
`cloud-itonami-isic-2920` is an OSS open-business blueprint for body-in-white
(BIW) stamping/welding body-shop manufacturing enablement, robotics-premised.

## Maintainers
Maintainers may merge changes that preserve these invariants:
- a robot action the governor refuses is never dispatched to hardware.
- the Stamping Governor remains independent of the Body Shop Advisor.
- hard policy violations (force-dispatch, record-suppression, unauthorized
